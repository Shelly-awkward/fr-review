    ...
    sections = [
      ...
      {"title": "二、個別資料庫", "body": [
        ...
        {"h": "（三）本期與去年同期應收帳款週轉率及存貨週轉率變動差異達10%，有無重大異常變動。",
         "paras": [(("；".join(tv_lines) + "。") if tv_lines else
                    "週轉率因缺前期平均餘額基礎數，無法由財報自動計算，請自行至公開資訊"
                    "觀測站財務業務資訊查填。")
      ...
      {"title": "三、財務報告審閱說明", "body": [
        {"h": "（一）使用權資產及租賃負債是否依IFRS16規定認列及衡量並揭露攸關資訊。",
         "paras": [
            ...
            "豁免適用、使用權資產與租賃負債之衡量），摘錄後註明出處"
            "「（詳財報附註『租賃』會計政策，第＿頁）」供承辦補頁碼；"
            "該節缺漏才寫「請自行核閱財報附註確認」】",
            f"財報揭露：已認列使用權資產{fmt(cur.get('使用權資產'))}及租賃負債-流動"
            f"{fmt(cur.get('租賃負債-流動'))}、租賃負債-非流動{fmt(cur.get('租賃負債-非流動'))}。"
            + AI + "揭露完整性：對照IFRS16應揭露要素（使用權資產衡量基礎與折舊、租賃負債"
            "衡量與增額借款利率、租賃期間及選擇權判斷、短期／低價值豁免）逐項敘明公司已揭露"
            "哪些；facts.notes 未摘到之要素不得推定公司未揭露，標「請自行核閱」。"
            "關係人租賃寫「請自行抽閱租約」。句末加註（詳財務報告第＿頁）供承辦補填】"]},
        {"h": "（二）金融資產是否依IFRS9規定認列及衡量，並依IFRS7規定揭露。",
         "paras": [
            ...
            "註明出處「（詳財報附註『金融工具』會計政策，第＿頁）」供承辦補頁碼】",
            AI + "揭露完整性：對照IFRS9/IFRS7應揭露要素（分類依據與經營模式、預期信用損失"
            "評估方法與假設、帳齡分析、信用風險與減損）逐項敘明公司已揭露哪些"
            "（facts.notes.FinancialInstruments、ScheduleOfTradeAndOtherReceivables、"
            "facts.age_distribution 有數字）；facts.notes 未摘到之要素不得推定公司未揭露，"
            "標「請自行核閱」。句末加註（詳財務報告第＿頁）供承辦補填】",
            ...
            "報價者之評價假設合理性屬公司始能說明事項，標「請洽公司說明」。"
            "facts.notes 無該節時寫「公允價值層級及評價技術之揭露，請自行核閱財報附註確認」，"
            "不得憑記憶補寫】"]},
        {"h": "（三）客戶合約之收入是否依IFRS15規定認列及衡量並為相關揭露。",
         "paras": [
            ...
            "公司未揭露，標「請自行核閱」。句末加註（詳財務報告第＿頁）供承辦補填】"]},
        {"h": "（四）對被投資公司持股未逾50%且為單一最大股東者，是否依IFRS10第B38~B50段評估權力並揭露重大判斷。",
         "paras": [
            AI + "被投資公司清單見 facts.investees（名稱/持股/帳面/損益），權益法政策見 "
            "facts.notes.InvestmentsInAssociates（引用時註明出處"
            "「（詳財報附註『採用權益法之投資』，第＿頁）」）。評估三要件、"
            "重大影響力判斷（董事席次、綜合持股）；持股低仍採權益法者寫「佐證文件請自行調閱」，"
      ...
      {"title": "四、會計主管審閱情形", "body": [
        {"paras": [
            ...
            "會計主管資格條件及專業進修辦法』之資格條件及持續進修規定，請自行至公開資訊觀測站"
      ...
      {"title": "附註：資料來源與限制", "body": [
        {"paras": [
            ...
            "財務重點專區、財報重編紀錄、裁罰紀錄及董監持股質押未及查詢，請自行至公開資訊"
...
def _endos_para(endos, equity, roc):
    ...
    return ("(2)背書保證（詳財報附表）：" + "；".join(rows) + "。"
            ...
            + AI + "背書原因屬公司才答得出者寫「請自行確認」；如可取得母公司合併報告"
